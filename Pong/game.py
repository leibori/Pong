...
# Global Variables
bg_color = pygame.Color('#07f52b')
accent_color = (27, 35, 43)
basic_font = pygame.font.Font('freesansbold.ttf', 32)
plob_sound = pygame.mixer.Sound("soccer.ogg")
score_sound = pygame.mixer.Sound("score.ogg")
middle_strip = pygame.Rect(screen_width / 2 - 2, 0, 4, screen_height)

# Game objects
player = Player('gloves.png', screen_width - 70, screen_height / 2, 5)
opponent = Opponent('gloves2.png', 70, screen_width / 2, 5)
